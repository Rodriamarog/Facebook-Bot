...
function simpleScrape() {
    return __awaiter(this, void 0, void 0, function () {
        var browser, _a, _b, page, title, error_1;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2: return [4 /*yield*/, _b.apply(_a, [(_c.executablePath = _d.sent(),
                            ...
                            _c)])];
                case 3:
                    // Launch the browser using puppeteer-core and chromium from chrome-aws-lambda
                    browser = _d.sent();
                    return [4 /*yield*/, browser.newPage()];
                case 4:
                    page = _d.sent();
                    // Go to the example domain
